...
def currency_exchange_debit(debit_CardNo=int, choice=str):
    if choice == "1":
        CurrencyExchange.CurrencyExchange_EUR_Debit(debit_CardNo)
    if choice == "2":
        CurrencyExchange.CurrencyExchange_GBP_Debit(debit_CardNo)
    if choice == "3":
        CurrencyExchange.CurrencyExchange_AUS_Debit(debit_CardNo)
    if choice == "4":
        CurrencyExchange.CurrencyExchange_CNY_Debit(debit_CardNo)


def currency_exchange_credit_USD(credit_CardNo=int, base=str):
    CurrencyExchange.CurrencyExchange_USD_Credit(credit_CardNo, base)


def currency_exchange_credit(credit_CardNo=int, choice=str):
    if choice == "1":
        CurrencyExchange.CurrencyExchange_EUR_Debit(credit_CardNo)
    if choice == "2":
        CurrencyExchange.CurrencyExchange_GBP_Debit(credit_CardNo)
    if choice == "3":
        CurrencyExchange.CurrencyExchange_AUS_Debit(credit_CardNo)
    if choice == "4":
        CurrencyExchange.CurrencyExchange_CNY_Debit(credit_CardNo)
